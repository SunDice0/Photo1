...
class ImageEditor(QMainWindow): 
    ...
    def do_left(self): 
        try: 
            self.photo=self.photo.filter(Image.ROTATE_90) 
            self.saveimage() 
            image_path=os.path.join(self.workdir,self.save_dir,self.filename) 
            self.showimage(image_path)
        except: 
    ...
    def do_right(self): 
        try: 
            self.photo=self.photo.filter(Image.ROTATE_270) 
            self.saveimage() 
            image_path=os.path.join(self.workdir,self.save_dir,self.filename) 
            self.showimage(image_path)
        except: 
    ...
    def do_mirror(self): 
        try: 
            self.photo=self.photo.filter(Image.FLIP_LEFT_RIGHT) 
            self.saveimage() 
            image_path=os.path.join(self.workdir,self.save_dir,self.filename) 
            self.showimage(image_path)
        except: 
    ...
    def do_contrast(self): 
        try: 
            self.photo=self.photo.Contrast(self.photo).enhance(1.5)
            self.saveimage() 
            image_path=os.path.join(self.workdir,self.save_dir,self.filename) 
            self.showimage(image_path)
        except: 
    ...
    def do_mirror_tb(self): 
        try: 
            self.photo=self.photo.filter(Image.FLIP_TOP_BOTTOM) 
            self.saveimage() 
            image_path=os.path.join(self.workdir,self.save_dir,self.filename) 
            self.showimage(image_path)
        except: 
